...
CREATE Table Course (CourseID int, CourseName varchar(255), CourseCode varchar(255));
CREATE Table Section (CourseID int, SectionID int);
CREATE Table Item(SectionID int, ItemID int, title int, itype varchar(255));
...
CREATE Table Event (EventID int, CourseID int, Duedate date);


CREATE Table Forum (ForumID int, CourseID int, ForumName varchar(255));
CREATE Table Thread (ThreadID int, ForumID int, Title varchar(255), Body varchar(255), created_by varchar(255)); --if parentID=0, it's the main thread
CREATE Table Replies (MainThreadID int, ReplyID int, ReplyBody varchar(255), created_by varchar(255));